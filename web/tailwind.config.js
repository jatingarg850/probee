...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Warm-tinted shadows: a neutral black shadow reads grey and dirty
        // against the paper ground, these keep the page feeling like paper.
        soft: '0 1px 2px rgba(20,20,19,0.04), 0 2px 8px rgba(20,20,19,0.04)',
        lift: '0 6px 20px rgba(20,20,19,0.07), 0 2px 6px rgba(20,20,19,0.04)',
        panel: '0 18px 48px rgba(20,20,19,0.12)',
      },
      keyframes: {
        'fade-up': {
